            ...
            <div class="grid grid-cols-3 w-full  gap-[30px]">
                <div class="bg-zinc-100/70 backdrop-blur-lg p-8 rounded-lg">
                    <div class="flex w-full justify-between text-[#FB8F2D]">
                        ...
                        <div class="">
                            <svg class="bg-[#FB8F2D] text-white p-3 rounded-full" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-award" viewBox="0 0 16 16">
                    ...
                    <div>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis voluptatem deserunt rem
                            quam soluta placeat iste et labore similique culpa.
                        </p>
                    </div>
                </div>
                <div class="bg-zinc-100/70 backdrop-blur-lg p-8 rounded-lg">
